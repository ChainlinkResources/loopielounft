...
function App() {
  ...
  const [feedback, setFeedback] = useState("What LOOPIIIEEE traits will your WOOF NFT have?");
  ...
  const claimNFTs = (_amount) => {
    ...
    setFeedback("Preparing your LoopieLou WOOF NFT...");
    setClaimingNft(true);
    blockchain.smartContract.methods
      .mint(blockchain.account, _amount)
      .send({
        gasLimit: "285000",
        to: "0x613b572918894D5e52FC27270633ACfe0B1fd54D",
      ...
      .then((receipt) => {
        setFeedback(
          "WOOOHOOOO! You just received a WOOF! This is a collection of 9663 LoopieLou NFTs! Visit Opensea.io to view your NFT!"
        );
        setClaimingNft(false);
            ...
            {Number(data.totalSupply) == 9663 ? (
              <>
                ...
                <s.TextDescription style={{ textAlign: "center" }}>
                  You can still buy and trade LoopieLou WOOF NFTs on{" "}
                  <a
                    target={""}
              ...
              <>
                ...
                blockchain.smartContract === null ? (
                  ...
                  <s.Container ai={"center"} jc={"center"} fd={"row"}>
                    ...
                    >
                      {claimingNft ? "Creating your WOOF NFT..." : "Buy 1 NFT"}
                    </StyledButton>
                  </s.Container>
                )}
              </>
